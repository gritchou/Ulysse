 ...
 * 
 */
@WebServiceClient(name = "project", targetNamespace = "http://org.qualipso.factory.ws/service/project", wsdlLocation = "http://localhost:8380/factory-project/project?wsdl")
public class Project_Service
    extends Service
{

    private final static URL PROJECT_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(org.qualipso.factory.collaboration.client.ws.Project_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.qualipso.factory.collaboration.client.ws.Project_Service.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:8380/factory-project/project?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8380/factory-project/project?wsdl', retrying as a local file");
