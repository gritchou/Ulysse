 ...
 * 
 */
@WebFault(name = "FactoryException", targetNamespace = "http://org.qualipso.factory.ws/service/core")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: org.qualipso.factory.collaboration.client.ws.FactoryException
     */
