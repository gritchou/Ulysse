 ...
 * 
 */
@WebServiceClient(name = "browser", targetNamespace = "http://org.qualipso.factory.ws/service/browser", wsdlLocation = "http://localhost:8380/factory-core/browser?wsdl")
public class Browser_Service
    extends Service
{

    private final static URL BROWSER_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(org.qualipso.factory.collaboration.client.ws.Browser_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.qualipso.factory.collaboration.client.ws.Browser_Service.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:8380/factory-core/browser?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8380/factory-core/browser?wsdl', retrying as a local file");
