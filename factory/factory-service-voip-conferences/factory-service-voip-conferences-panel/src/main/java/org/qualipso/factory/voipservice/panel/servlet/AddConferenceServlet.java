...
public class AddConferenceServlet extends QualipsoHTTPServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ((confTime != null) && confTime.equals("permanent")) {
			permanent = true;
		}

		Long startDateNumber = null;
		Long endDateNumber = null;
		...
		try {
			...
			asterisk.createConference(servletUserId, servletUserPass, owner, 
					accessType, permanent,
					pin, adminpin,
					startDateNumber, endDateNumber,
					maxUsersNumber, invited, name, agenda, rec, servletProjectId);
