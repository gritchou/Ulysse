				...
				if (pr != null) {
					...
					if (md != null) {
						if (md.equals(Presence.Mode.AVAILABLE)) {
							...
							cn.setPresence("chat");
						} else if (md.equals(Presence.Mode.DO_NOT_DISTURB)) {
							cn.setPresence("disturb");
						} else if (md.equals(Presence.Mode.EXTENDED_AWAY)) {
							cn.setPresence("extended_away");
						} else if (md.equals(Presence.Mode.INVISIBLE)) {
							cn.setPresence("invisible");
						}
...
//				if (!tmp.getPresence().equals("offline")) {
					...
					out.println("	<td width=\"10\"><img src=\"img/indicators/" + color + ".gif\" id=\"indicator\"/></td>");
...
//			}
			...
			out.print("<br /><br /><br /><div align=\"center\"><img src=\"img/loading.gif\" width=\"32\" height=\"32\">");
		}
