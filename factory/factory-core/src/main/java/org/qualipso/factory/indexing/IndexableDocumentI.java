...
/**
 * <p>
 * Interface which specify the property of indexable document. Documents are the
...
public interface IndexableDocumentI {
    ...
    /**
     * <p>
     * Set a Factory Resource Identifier (FRI) reference of resource with a
     * string
     * </p>
     * 
     * @param resourceFRI
    ...
    /**
     *<p>
     * Give the path to the corresponding resource
     * </p>
     * 
