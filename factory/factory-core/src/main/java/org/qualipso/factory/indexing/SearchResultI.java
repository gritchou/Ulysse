...
/**
 * <p>
 * Interface which allows to get back the answer of a request for a research
...
public interface SearchResultI extends Serializable {
     ...
     * 
     * @param path
     *            , a string which correspond the path
     */
     ...
     * 
     * @param score
     *            , a number of type float which correspond the score
     */
     ...
     * 
     * @param name
     *            , the string which is the name of document
     */
     ...
     * 
     * @param type
     *            , a string which is the type of document
     */
