...
@WebService(endpointInterface = "org.qualipso.factory.search.SearchService", targetNamespace = FactoryNamingConvention.SERVICE_NAMESPACE + SearchService.SERVICE_NAME, serviceName = SearchService.SERVICE_NAME)
@WebContext(contextRoot = FactoryNamingConvention.WEB_SERVICE_CORE_MODULE_CONTEXT, urlPattern = FactoryNamingConvention.WEB_SERVICE_URL_PATTERN_PREFIX + SearchService.SERVICE_NAME)
