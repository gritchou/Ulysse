...
@XmlSeeAlso(value =  {
    File.class, Folder.class, Link.class, Group.class, Profile.class}
)
public abstract class FactoryResource implements Serializable {
    ...
    //	public String toXML() throws FactoryException {
    //		ByteArrayOutputStream baos = new ByteArrayOutputStream();
    //		
    //		try {
    //			JAXBContext jc = JAXBContext.newInstance("mydomain");
    ...
    public String toJSON() throws FactoryException {
    ...
    public String toString() {
    	return "{path:" + getResourcePath() + "; identifier:" + getFactoryResourceIdentifier() + "; name:" + getResourceName() + "}";
    }
}
