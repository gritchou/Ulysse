...
public class PAPServiceHelper {
	...
	public static String addRuleToPolicy(String policy, String subject, String[] actions) throws PAPServiceException {
		try {
			DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
			DocumentBuilder docBuilder = factory.newDocumentBuilder();
	...
	public static String removeRuleFromPolicy(String policy, String subject) throws PAPServiceException {
		try {
			DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
			DocumentBuilder docBuilder = factory.newDocumentBuilder();
			Document doc = docBuilder.parse(new ByteArrayInputStream(policy.getBytes()));
