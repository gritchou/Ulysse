...
public interface BindingService {
     ...
     * @throws PathNotFoundException if the path does not exists
     */
    public String[] list(String path) throws BindingServiceException, InvalidPathException, PathNotFoundException;
    ...
    public String getProperty(String path, String name, boolean inherited)
        throws BindingServiceException, InvalidPathException, PathNotFoundException, PropertyNotFoundException;
