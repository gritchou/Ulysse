...
public class IndexingServiceSBTest {
    ...
    /**
     * Set up the context before each test. We create 4 resources Name and get
     * their FactoryResourceIdentifier, and create profile toto.
     * 
     * @throws NamingException
     ...
     * resource can find it. This method give the ownership to user toto, and
     * keep the read right for kermit.
     * 
     * @throws LoginException
     * @throws SecurityServiceException
     * @throws SearchServiceException
