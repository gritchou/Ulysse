    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.qualipso.factory.client.ws.Browser_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.qualipso.factory.client.ws.Browser_Service.class.getResource(".");
