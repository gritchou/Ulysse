 ...
 * 
 */
@WebFault(name = "FactoryException", targetNamespace = "http://org.qualipso.factory.ws/service/security")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: org.qualipso.factory.client.ws.FactoryException
     */
