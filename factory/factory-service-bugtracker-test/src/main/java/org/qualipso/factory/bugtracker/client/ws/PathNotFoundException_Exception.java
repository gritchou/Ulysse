 ...
 * 
 */
@WebFault(name = "PathNotFoundException", targetNamespace = "http://org.qualipso.factory.ws/service/bootstrap")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: org.qualipso.factory.bugtracker.client.ws.PathNotFoundException
     */
