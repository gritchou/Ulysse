 ...
 * 
 */
@WebFault(name = "FactoryException", targetNamespace = "http://org.qualipso.factory.ws/service/git")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: org.qualipso.factory.git.client.ws.FactoryException
     */
