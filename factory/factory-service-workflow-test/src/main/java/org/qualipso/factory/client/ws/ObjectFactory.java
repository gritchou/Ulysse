...
public class ObjectFactory {
    ...
    private final static QName _AccessDeniedException_QNAME = new QName("http://org.qualipso.factory.ws/service/svn", "AccessDeniedException");
    private final static QName _FactoryException_QNAME = new QName("http://org.qualipso.factory.ws/service/svn", "FactoryException");
    private final static QName _PathNotFoundException_QNAME = new QName("http://org.qualipso.factory.ws/service/svn", "PathNotFoundException");
    private final static QName _Folder_QNAME = new QName("http://org.qualipso.factory.ws/service/svn", "folder");
    private final static QName _InvalidPathException_QNAME = new QName("http://org.qualipso.factory.ws/service/svn", "InvalidPathException");
    private final static QName _SVNServiceException_QNAME = new QName("http://org.qualipso.factory.ws/service/svn", "SVNServiceException");
    ...
    /**
     * Create an instance of {@link SvnRepository }
     * 
     */
    ...
    /**
     * Create an instance of {@link SVNServiceException }
     * 
     */
    public SVNServiceException createSVNServiceException() {
        return new SVNServiceException();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.qualipso.factory.ws/service/svn", name = "AccessDeniedException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.qualipso.factory.ws/service/svn", name = "FactoryException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.qualipso.factory.ws/service/svn", name = "PathNotFoundException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.qualipso.factory.ws/service/svn", name = "folder")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.qualipso.factory.ws/service/svn", name = "InvalidPathException")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SVNServiceException }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://org.qualipso.factory.ws/service/svn", name = "SVNServiceException")
    public JAXBElement<SVNServiceException> createSVNServiceException(SVNServiceException value) {
        return new JAXBElement<SVNServiceException>(_SVNServiceException_QNAME, SVNServiceException.class, null, value);
    }
