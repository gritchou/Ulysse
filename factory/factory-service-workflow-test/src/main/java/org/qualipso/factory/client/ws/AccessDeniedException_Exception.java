 ...
 * 
 */
@WebFault(name = "AccessDeniedException", targetNamespace = "http://org.qualipso.factory.ws/service/workflow")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: org.qualipso.factory.client.ws.AccessDeniedException
     */
