...
@Entity
@XmlType(name = "Document", namespace = "http://org.qualipso.factory.ws/resource/document", propOrder = {
	"name", "author", "date", "type", "keywords", "version", "status", "fileName",
	"mimeType", "binaryContent", "size","parentFolderID" })
...
public class Document extends FactoryResource
{
    ...
    {
	return new FactoryResourceIdentifier("DocumentService", "Document", getId());
    }
