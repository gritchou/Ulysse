 ...
 * 
 */
@WebServiceClient(name = "membership", targetNamespace = "http://org.qualipso.factory.ws/service/membership", wsdlLocation = "http://localhost:8080/factory-core/membership?wsdl")
public class Membership_Service
    extends Service
{

    private final static URL MEMBERSHIP_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(org.qualipso.factory.svn.client.ws.Membership_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.qualipso.factory.svn.client.ws.Membership_Service.class.getResource(".");
