        ...
        try {
            mockery.checking(new Expectations() {

                    {
                        ...
                        inSequence(sequence1);
                        oneOf(pep).checkSecurity(with(equal(new String[] { "/profiles/jayblanc" })), with(equal("/names")), with(equal("create")));
                        inSequence(sequence1);
                        oneOf(binding).bind(with(any(FactoryResourceIdentifier.class)), with(equal("/names/sheldon")));
                        will(saveParams(params1));
                        inSequence(sequence1);
                        oneOf(binding)
                            .setProperty(with(equal("/names/sheldon")), with(equal(FactoryResourceProperty.CREATION_TIMESTAMP)), with(any(String.class)));
                        inSequence(sequence1);
                        oneOf(binding)
                            .setProperty(with(equal("/names/sheldon")), with(equal(FactoryResourceProperty.LAST_UPDATE_TIMESTAMP)), with(any(String.class)));
                        inSequence(sequence1);
                        oneOf(binding).setProperty(with(equal("/names/sheldon")), with(equal(FactoryResourceProperty.AUTHOR)), with(equal("/profiles/jayblanc")));
                        inSequence(sequence1);
                        oneOf(pap).createPolicy(with(any(String.class)), with(containsString("/names/sheldon")));
                        inSequence(sequence1);
                        oneOf(binding).setProperty(with(equal("/names/sheldon")), with(equal(FactoryResourceProperty.OWNER)), with(equal("/profiles/jayblanc")));
                        inSequence(sequence1);
                        oneOf(binding).setProperty(with(equal("/names/sheldon")), with(equal(FactoryResourceProperty.POLICY_ID)), with(any(String.class)));
                        inSequence(sequence1);
                        oneOf(notification).throwEvent(with(anEventWithTypeEqualsTo("greeting.name.create")));
                        inSequence(sequence1);
                        oneOf(indexing).index(with(equal("/names/sheldon")));
                        inSequence(sequence1);
                        ...
                        oneOf(pep).checkSecurity(with(equal(new String[] { "/profiles/jayblanc" })), with(equal("/names")), with(equal("create")));
                        inSequence(sequence1);
                        oneOf(binding).bind(with(any(FactoryResourceIdentifier.class)), with(equal("/names/howard")));
                        will(saveParams(params2));
                        inSequence(sequence1);
                        oneOf(binding)
                            .setProperty(with(equal("/names/howard")), with(equal(FactoryResourceProperty.CREATION_TIMESTAMP)), with(any(String.class)));
                        inSequence(sequence1);
                        oneOf(binding)
                            .setProperty(with(equal("/names/howard")), with(equal(FactoryResourceProperty.LAST_UPDATE_TIMESTAMP)), with(any(String.class)));
                        inSequence(sequence1);
                        oneOf(binding).setProperty(with(equal("/names/howard")), with(equal(FactoryResourceProperty.AUTHOR)), with(equal("/profiles/jayblanc")));
                        inSequence(sequence1);
                        oneOf(pap).createPolicy(with(any(String.class)), with(containsString("/names/howard")));
                        inSequence(sequence1);
                        oneOf(binding).setProperty(with(equal("/names/howard")), with(equal(FactoryResourceProperty.OWNER)), with(equal("/profiles/jayblanc")));
                        inSequence(sequence1);
                        oneOf(binding).setProperty(with(equal("/names/howard")), with(equal(FactoryResourceProperty.POLICY_ID)), with(any(String.class)));
                        inSequence(sequence1);
                        oneOf(notification).throwEvent(with(anEventWithTypeEqualsTo("greeting.name.create")));
                        inSequence(sequence1);
                        oneOf(indexing).index(with(equal("/names/howard")));
                        inSequence(sequence1);
                    }
                });
            ...
            mockery.checking(new Expectations() {

                    {
                        ...
                        will(returnValue(new String[] { "/profiles/jayblanc" }));
                        inSequence(sequence1);
                        oneOf(pep).checkSecurity(with(equal(new String[] { "/profiles/jayblanc" })), with(equal("/names/sheldon")), with(equal("read")));
                        inSequence(sequence1);
                        oneOf(binding).lookup(with(equal("/names/sheldon")));
                        will(returnValue(params1.get(0)));
                        inSequence(sequence1);
                        oneOf(notification).throwEvent(with(anEventWithTypeEqualsTo("greeting.name.read")));
                        inSequence(sequence1);
                        ...
                        will(returnValue(new String[] { "/profiles/jayblanc" }));
                        inSequence(sequence1);
                        oneOf(pep).checkSecurity(with(equal(new String[] { "/profiles/jayblanc" })), with(equal("/names/howard")), with(equal("read")));
                        inSequence(sequence1);
                        oneOf(binding).lookup(with(equal("/names/howard")));
            ...
            mockery.checking(new Expectations() {

                    {
                        ...
                        will(returnValue(new String[] { "/profiles/jayblanc" }));
                        inSequence(sequence1);
                        oneOf(pep).checkSecurity(with(equal(new String[] { "/profiles/jayblanc" })), with(equal("/names/sheldon")), with(equal("update")));
                        inSequence(sequence1);
                        oneOf(binding).lookup(with(equal("/names/sheldon")));
                        will(returnValue(params1.get(0)));
                        inSequence(sequence1);
                        oneOf(binding)
                            .setProperty(with(equal("/names/sheldon")), with(equal(FactoryResourceProperty.LAST_UPDATE_TIMESTAMP)), with(any(String.class)));
                        inSequence(sequence1);
                        oneOf(notification).throwEvent(with(anEventWithTypeEqualsTo("greeting.name.update")));
                        inSequence(sequence1);
                        oneOf(indexing).reindex(with(equal("/names/sheldon")));
                        inSequence(sequence1);
                        ...
                        will(returnValue(new String[] { "/profiles/jayblanc" }));
                        inSequence(sequence1);
                        oneOf(pep).checkSecurity(with(equal(new String[] { "/profiles/jayblanc" })), with(equal("/names/howard")), with(equal("update")));
                        inSequence(sequence1);
                        oneOf(binding).lookup(with(equal("/names/howard")));
                        will(returnValue(params2.get(0)));
                        inSequence(sequence1);
                        ...
                        oneOf(notification).throwEvent(with(anEventWithTypeEqualsTo("greeting.name.update")));
                        inSequence(sequence1);
                        oneOf(indexing).reindex(with(equal("/names/howard")));
                        inSequence(sequence1);
            ...
            mockery.checking(new Expectations() {

                    {
                        ...
                        will(returnValue(new String[] { "/profiles/jayblanc" }));
                        inSequence(sequence1);
                        oneOf(pep).checkSecurity(with(equal(new String[] { "/profiles/jayblanc" })), with(equal("/names/sheldon")), with(equal("delete")));
                        inSequence(sequence1);
                        oneOf(binding).lookup(with(equal("/names/sheldon")));
                        will(returnValue(params1.get(0)));
                        inSequence(sequence1);
                        oneOf(binding).getProperty(with(equal("/names/sheldon")), with(equal(FactoryResourceProperty.POLICY_ID)), with(equal(false)));
                        inSequence(sequence1);
                        oneOf(pap).deletePolicy(with(any(String.class)));
                        inSequence(sequence1);
                        oneOf(binding).unbind(with(equal("/names/sheldon")));
                        inSequence(sequence1);
                        oneOf(notification).throwEvent(with(anEventWithTypeEqualsTo("greeting.name.delete")));
                        inSequence(sequence1);
                        oneOf(indexing).remove(with(equal("/names/sheldon")));
                        inSequence(sequence1);
                        ...
                        will(returnValue(new String[] { "/profiles/jayblanc" }));
                        inSequence(sequence1);
                        oneOf(pep).checkSecurity(with(equal(new String[] { "/profiles/jayblanc" })), with(equal("/names/howard")), with(equal("delete")));
                        inSequence(sequence1);
                        oneOf(binding).lookup(with(equal("/names/howard")));
                        will(returnValue(params2.get(0)));
                        inSequence(sequence1);
                        oneOf(binding).getProperty(with(equal("/names/howard")), with(equal(FactoryResourceProperty.POLICY_ID)), with(equal(false)));
                        inSequence(sequence1);
                        oneOf(pap).deletePolicy(with(any(String.class)));
                        inSequence(sequence1);
                        oneOf(binding).unbind(with(equal("/names/howard")));
                        inSequence(sequence1);
                        oneOf(notification).throwEvent(with(anEventWithTypeEqualsTo("greeting.name.delete")));
                        inSequence(sequence1);
                        oneOf(indexing).remove(with(equal("/names/howard")));
                        inSequence(sequence1);
                    }
                });
        ...
        try {
            mockery.checking(new Expectations() {

                    {
                        ...
                        will(returnValue("/profiles/jayblanc"));
                        allowing(membership).getConnectedIdentifierSubjects();
                        allowing(binding).bind(with(any(FactoryResourceIdentifier.class)), with(any(String.class)));
                        will(saveParams(params));
                        allowing(binding).setProperty(with(any(String.class)), with(any(String.class)), with(any(String.class)));
                        allowing(indexing).index(with(any(String.class)));
                    }
                });
